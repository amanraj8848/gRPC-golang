...
const (
	...
	GreetService_SayHelloBiStreaming_FullMethodName     = "/greet_service.GreetService/SayHelloBiStreaming"
)
...
type GreetServiceClient interface {
	SayHello(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HelloReply, error)
	SayHelloServerStreaming(ctx context.Context, in *NameList, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloReply], error)
	...
	SayHelloBiStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloReply], error)
}
...
func (c *greetServiceClient) SayHello(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HelloReply, error) {
...
func (c *greetServiceClient) SayHelloServerStreaming(ctx context.Context, in *NameList, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloReply], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[NameList, HelloReply]{ClientStream: stream}
...
type GreetService_SayHelloServerStreamingClient = grpc.ServerStreamingClient[HelloReply]
...
func (c *greetServiceClient) SayHelloBiStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloReply], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], GreetService_SayHelloBiStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBiStreamingClient = grpc.BidiStreamingClient[HelloRequest, HelloReply]

// GreetServiceServer is the server API for GreetService service.
// All implementations must embed UnimplementedGreetServiceServer
// for forward compatibility.
type GreetServiceServer interface {
	SayHello(context.Context, *NoParam) (*HelloReply, error)
	SayHelloServerStreaming(*NameList, grpc.ServerStreamingServer[HelloReply]) error
	SayHelloClientStreaming(grpc.ClientStreamingServer[HelloRequest, MessageList]) error
	SayHelloBiStreaming(grpc.BidiStreamingServer[HelloRequest, HelloReply]) error
...
func (UnimplementedGreetServiceServer) SayHello(context.Context, *NoParam) (*HelloReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHello not implemented")
}
func (UnimplementedGreetServiceServer) SayHelloServerStreaming(*NameList, grpc.ServerStreamingServer[HelloReply]) error {
...
func (UnimplementedGreetServiceServer) SayHelloBiStreaming(grpc.BidiStreamingServer[HelloRequest, HelloReply]) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBiStreaming not implemented")
}
...
func _GreetService_SayHelloServerStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GreetServiceServer).SayHelloServerStreaming(m, &grpc.GenericServerStream[NameList, HelloReply]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloServerStreamingServer = grpc.ServerStreamingServer[HelloReply]
...
func _GreetService_SayHelloBiStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBiStreaming(&grpc.GenericServerStream[HelloRequest, HelloReply]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBiStreamingServer = grpc.BidiStreamingServer[HelloRequest, HelloReply]
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBiStreaming",
			Handler:       _GreetService_SayHelloBiStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
